        ...
        <table class="form-table wp-list-table widefat striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" name="GLS_user" value="<?= esc_attr(get_option('GLS_user')); ?>" size="50" placeholder="Numele utilizatorului GLS" required/></td>
                </tr>

                <tr>
                    <th align="left">Parola GLS:</th>
                    <td><input type="password" name="GLS_password" value="<?= esc_attr(get_option('GLS_password')); ?>" size="50" placeholder="Parola utilizatorului GLS" required/></td>
                </tr>

                <tr>
                    <th align="left">ID expeditor:</th>
                    <td><input type="text" name="GLS_senderid" value="<?= esc_attr(get_option('GLS_senderid')); ?>" size="50" placeholder="ID expeditor GLS (deseori acelasi ca numele utilizatorului GLS)" required/></td>
                </tr>
        ...
        <table class="form-table wp-list-table widefat striped">
            ...
            <tbody>
                ...
                <tr class="other_sender_row">
                    <th align="left">Nume expeditor:</th>
                    <td><input disabled type="text" name="GLS_other_senders[new][name]" value="" size="50" placeholder="Ex: SC. FirmaTest SRL."/></td>
                </tr>

                <tr class="other_sender_row">
                    <th align="left">Adresa expeditor:</th>
                    <td><input disabled type="text" name="GLS_other_senders[new][address]" value="" size="50" placeholder="Ex: Str. Aurel Vlaicu Nr. 3-A"/></td>
                </tr>

                <tr class="other_sender_row">
                    <th align="left">Localitate expeditor:</th>
                    <td><input disabled type="text" name="GLS_other_senders[new][city]" value="" size="50" placeholder="Ex: Timisoara"/></td>
                </tr>

                <tr class="other_sender_row">
                    <th align="left">Cod postal expeditor:</th>
                    <td><input disabled type="text" name="GLS_other_senders[new][zipcode]" value="" size="50" placeholder="Ex: 300702"/></td>
                </tr>

                <tr class="other_sender_row">
                    <th align="left">Telefon expeditor:</th>
                    <td><input disabled type="text" name="GLS_other_senders[new][phone]" value="" size="50" placeholder="Ex: 0799123456"/></td>
                </tr>

                <tr class="other_sender_row">
                    <th align="left">Email expeditor:</th>
                    <td><input disabled type="text" name="GLS_other_senders[new][email]" value="" size="50" placeholder="Ex: test@email.com"/></td>
                </tr>

                <tr class="other_sender_row">
                    <th align="left">Nume persoana contact:</th>
                    <td><input disabled type="text" name="GLS_other_senders[new][contact]" value="" size="50" placeholder="Ex: Ionut Popescu"/></td>
                </tr>
        ...
        <table class="form-table wp-list-table widefat striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" name="GLS_titlu_mail" value="<?= esc_attr(get_option('GLS_titlu_mail')); ?>" size="50" placeholder="Ex: Comanda expediata!"/></td>
                </tr>
                <tr>
                    <th align="left">
                        <div class="has_help_tip">
                ...
                <tr>
                    ...
                    <td>
                        <select name="GLS_auto_generate_awb">
                            <option value="nu" <?= esc_attr( get_option('GLS_auto_generate_awb') ) == 'nu' ? 'selected="selected"' : ''; ?>>Nu</option>
                            <option value="da" <?= esc_attr( get_option('GLS_auto_generate_awb') ) == 'da' ? 'selected="selected"' : ''; ?>>Da</option>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="GLS_auto_mark_complete">
                            <option value="nu" <?= esc_attr( get_option('GLS_auto_mark_complete') ) == 'nu' ? 'selected="selected"' : ''; ?>>Nu</option>
                            <option value="da" <?= esc_attr( get_option('GLS_auto_mark_complete') ) == 'da' ? 'selected="selected"' : ''; ?>>Da</option>
                        </select>
                    </td>
                </tr>
            </tbody>
...
<script>
    jQuery($ => {
        const url = "<?= curiero_get_api_url('/v1/auth/validate/gls') ?>";
        ...
        $('button.remove_other_sender').on('click', async function () {
            ...
            removeForm.append('action', 'curiero_remove_other_gls_sender');
