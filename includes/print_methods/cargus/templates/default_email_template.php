...
$email_template_field = 'uc_email_template';
$email_subject_field = 'uc_subiect_mail';
$email_title_field = 'uc_titlu_mail';

$default_template = 'Buna ziua,
<br>
Comanda dumneavoastra cu numarul: [nr_comanda] din data de [data_comanda] a fost expediata prin serviciu de curierat Cargus si este in curs de livrare.
<br>
Nota de transport (AWB-ul) are numarul [nr_awb] si poate fi urmarita aici: <a href="https://cargus.ro/tracking-romanian/?t=[nr_awb]" target="_blank">Status comanda</a>
<br>
...
<br>
Daca nu sunteti contactat in maximum 2 zile lucratoare de la plasarea comenzii, va rog sa contactati compania Cargus la telefon 021 9282 (Provincie) / 021 9330 (Bucuresti).
<br>
...
register_setting('cargus_settings', $email_template_field);
register_setting('cargus_settings', $email_subject_field);
register_setting('cargus_settings', $email_title_field);
