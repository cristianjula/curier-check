...
$email_template_field = 'dpd_email_template';
$email_subject_field = 'dpd_subiect_mail';
$email_title_field = 'dpd_titlu_mail';
...
register_setting('dpd_settings', $email_template_field);
register_setting('dpd_settings', $email_subject_field);
register_setting('dpd_settings', $email_title_field);
