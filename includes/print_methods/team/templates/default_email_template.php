...
$email_template_field = 'team_email_template';
$email_subject_field = 'team_subiect_mail';
$email_title_field = 'team_titlu_mail';
...
register_setting('team_settings', $email_template_field);
register_setting('team_settings', $email_subject_field);
register_setting('team_settings', $email_title_field);
