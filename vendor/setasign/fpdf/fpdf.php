...
class FPDF
{
    ...
    *******************************************************************************/
    function __construct($orientation = 'P', $unit = 'mm', $size = 'A4')
    {
        ...
        // Font path
        if (\defined('CurieRO\FPDF_FONTPATH')) {
            $this->fontpath = \CurieRO\FPDF_FONTPATH;
        } else {
        ...
        // Line width (0.2 mm)
        $this->LineWidth = 0.5669999999999999 / $this->k;
        // Automatic page break
        $this->SetAutoPageBreak(\true, 2 * $margin);
        // Default display mode
        $this->SetDisplayMode('default');
        // Enable compression
        $this->SetCompression(\true);
        // Metadata
    ...
    *******************************************************************************/
    ...
    protected function _parsepngstream($f, $file)
    {
        ...
        if ($ct >= 4) {
            ...
            if (!\function_exists('gzuncompress') && !\function_exists('CurieRO\gzuncompress')) {
    ...
    protected function _parsegif($file)
    {
        ...
        if (!\function_exists('imagepng') && !\function_exists('CurieRO\imagepng')) {
            $this->Error('GD extension is required for GIF support');
        }
        if (!\function_exists('imagecreatefromgif') && !\function_exists('CurieRO\imagecreatefromgif')) {
