...
namespace CurieRO\Sameday\Objects\PostAwb\Request;

use CurieRO\Sameday\Objects\Types\PersonType;
/**
 * Entity.
 *
 * @package Sameday
...
class EntityObject
{
     ...
     */
    public function __construct($city, $county, $address, $name, $phone, CompanyEntityObject $company = null, $postalCode = null)
    {
        $this->city = $city;
        $this->county = $county;
    ...
    {
        $fields = ['name' => $this->name, 'phoneNumber' => $this->phone, 'address' => $this->address, 'personType' => PersonType::INDIVIDUAL];
        if (is_int($this->city)) {
