...
namespace CurieRO\Sameday\Objects\AwbStatusHistory;
...
class SummaryObject
{
     ...
     */
    public function __construct($delivered, $canceled, $deliveryAttempts, $awbNumber, $awbWeight, $servicePayment, $cashOnDelivery, $redirectionAttempts = 0, DateTime $deliveredAt = null, DateTime $lastDeliveryAttempt = null)
    {
