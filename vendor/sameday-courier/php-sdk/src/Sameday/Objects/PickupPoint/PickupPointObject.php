...
namespace CurieRO\Sameday\Objects\PickupPoint;
...
class PickupPointObject
{
     ...
     * @param string $alias
     */
    public function __construct($id, CountyObject $county, CityObject $city, $address, $default, array $contactPersons, $alias)
    {
        $this->id = $id;
        $this->county = $county;
        $this->city = $city;
