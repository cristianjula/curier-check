...
class ExpeditionObject extends HistoryObject
{
     ...
     */
    public function __construct($id, $name, $label, $state, DateTime $date, $county, $reason, $transitLocation, $expeditionDetails)
    {
        parent::__construct($id, $name, $label, $state, $date, $county, $reason, $transitLocation);
