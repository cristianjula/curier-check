...
namespace CurieRO\Sameday\Objects\ParcelStatusHistory;
...
class SummaryObject
{
     ...
     */
    public function __construct($delivered, $canceled, $deliveryAttempts, $parcelAwbNumber, $parcelWeight, $pickedUp, DateTime $deliveredAt = null, DateTime $lastDeliveryAttempt = null, DateTime $pickedUpAt = null)
    {
