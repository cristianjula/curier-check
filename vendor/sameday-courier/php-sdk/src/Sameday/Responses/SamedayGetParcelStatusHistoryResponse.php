...
use CurieRO\Sameday\Objects\ParcelStatusHistory\ExpeditionObject;
use CurieRO\Sameday\Objects\ParcelStatusHistory\HistoryObject;
use CurieRO\Sameday\Objects\ParcelStatusHistory\SummaryObject;
...
class SamedayGetParcelStatusHistoryResponse implements SamedayResponseInterface
{
    ...
    {
        return new ExpeditionObject($json['statusId'], $json['status'], $json['statusLabel'], $json['statusState'], new DateTime($json['statusDate']), $json['county'], $json['reason'], $json['transitLocation'], $json['expeditionDetails']);
    }
}
