...
class SamedayPutParcelSizeRequest implements SamedayRequestInterface
{
    ...
    {
        return new SamedayRequest(\true, 'PUT', "/api/client/parcel/{$this->parcel}/size", [], new RequestBodyUrlEncoded(['weight' => $this->weight, 'width' => $this->width, 'length' => $this->length, 'height' => $this->height]));
    }
    /**
     * @return string
     */
