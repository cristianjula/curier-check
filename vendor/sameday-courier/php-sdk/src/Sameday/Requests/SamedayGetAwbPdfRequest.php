...
use CurieRO\Sameday\Objects\Types\AwbPdfType;
/**
...
class SamedayGetAwbPdfRequest implements SamedayRequestInterface
{
     ...
     */
    public function __construct($awbNumber, AwbPdfType $awbPdfType)
    {
    ...
    {
        return new SamedayRequest(\true, 'GET', "/api/awb/download/{$this->awbNumber}/{$this->awbPdfType->getType()}", []);
    }
    /**
     * @return string
     */
