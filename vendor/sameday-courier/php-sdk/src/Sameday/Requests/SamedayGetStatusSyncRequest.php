...
class SamedayGetStatusSyncRequest implements SamedayPaginatedRequestInterface
{
    ...
    {
        return new SamedayRequest(\true, 'GET', '/api/client/status-sync', array_merge(['startTimestamp' => $this->startTimestamp, 'endTimestamp' => $this->endTimestamp], $this->buildPagination()));
    }
    /**
     * @return int
     */
