...
class SamedayGetCitiesRequest implements SamedayPaginatedRequestInterface
{
    ...
    {
        return new SamedayRequest(\true, 'GET', '/api/geolocation/city', array_merge(['county' => $this->countyId, 'name' => $this->name, 'postalCode' => $this->postalCode], $this->buildPagination()));
    }
    /**
     * @return int|null
     */
