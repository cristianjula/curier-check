...
class SamedayPostAwbEstimationRequest implements SamedayRequestInterface
{
     ...
     */
    public function __construct($pickupPointId, $contactPersonId, PackageType $packageType, array $parcelsDimensions, $serviceId, AwbPaymentType $awbPayment, AwbRecipientEntityObject $awbRecipient, $insuredValue, $cashOnDeliveryAmount = 0.0, ThirdPartyPickupEntityObject $thirdPartyPickup = null, array $serviceTaxIds = [])
    {
    ...
    public function buildRequest()
    {
        ...
        return new SamedayRequest(\true, 'POST', '/api/awb/estimate-cost', [], new RequestBodyUrlEncoded($body));
    }
    /**
     * @return int
     */
