...
namespace CurieRO\Sameday\PersistentData;
...
class PersistentDataFactory
{
    ...
    {
        if (!$handler) {
            return (session_status() === \PHP_SESSION_ACTIVE) ? new SamedaySessionPersistentDataHandler() : new SamedayMemoryPersistentDataHandler();
        }
