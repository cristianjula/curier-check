...
use DateTime;
use Exception;
use CurieRO\Sameday\Exceptions\SamedayAuthenticationException;
use CurieRO\Sameday\Exceptions\SamedayAuthorizationException;
use CurieRO\Sameday\Exceptions\SamedayBadRequestException;
use CurieRO\Sameday\Exceptions\SamedayNotFoundException;
use CurieRO\Sameday\Exceptions\SamedayOtherException;
use CurieRO\Sameday\Exceptions\SamedaySDKException;
use CurieRO\Sameday\Exceptions\SamedayServerException;
use CurieRO\Sameday\Http\SamedayRawResponse;
use CurieRO\Sameday\Http\SamedayRequest;
use CurieRO\Sameday\HttpClients\HttpClientsFactory;
use CurieRO\Sameday\HttpClients\SamedayHttpClientInterface;
use CurieRO\Sameday\PersistentData\PersistentDataFactory;
use CurieRO\Sameday\PersistentData\SamedayPersistentDataInterface;
use CurieRO\Sameday\Requests\SamedayAuthenticateRequest;
use CurieRO\Sameday\Responses\SamedayAuthenticateResponse;
/**
...
class SamedayClient implements SamedayClientInterface
{
     ...
     */
    public function __construct($username, $password, $host = null, $platformName = null, $platformVersion = null, $httpClientHandler = null, $persistentDataHandler = null)
    {
    ...
    public function sendRequest(SamedayRequest $request)
    {
        ...
        while (++$try) {
            ...
            $rawResponse = $this->httpClientHandler->send($url, $request->getMethod(), $request->getBody() ? $request->getBody()->getBody() : '', $headers, $request->getTimeout());
     ...
     * @throws Exception
     */
    protected function getToken($usePersistentData = \true)
    {
