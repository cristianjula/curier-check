...
namespace CurieRO\Sameday\HttpClients;

use CurieRO\Sameday\Http\SamedayRawResponse;
use CurieRO\Sameday\Exceptions\SamedaySDKException;
use CurieRO\GuzzleHttp\Client;
use CurieRO\GuzzleHttp\Message\ResponseInterface;
use CurieRO\GuzzleHttp\Ring\Exception\RingException;
use CurieRO\GuzzleHttp\Exception\RequestException;
/**
...
class SamedayGuzzleHttpClient implements SamedayHttpClientInterface
{
    ...
    {
        $options = ['headers' => $headers, 'body' => $body, 'timeout' => $timeOut, 'connect_timeout' => 10];
