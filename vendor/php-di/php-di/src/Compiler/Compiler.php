...
namespace CurieRO\DI\Compiler;

use function chmod;
use CurieRO\DI\Definition\ArrayDefinition;
use CurieRO\DI\Definition\DecoratorDefinition;
...
use CurieRO\DI\DependencyException;
use CurieRO\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use CurieRO\Opis\Closure\SerializableClosure;
use function rename;
