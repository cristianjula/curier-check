...
namespace CurieRO\DI\Proxy;

use CurieRO\ProxyManager\Configuration;
use CurieRO\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use CurieRO\ProxyManager\FileLocator\FileLocator;
use CurieRO\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use CurieRO\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use CurieRO\ProxyManager\Proxy\LazyLoadingInterface;
/**
