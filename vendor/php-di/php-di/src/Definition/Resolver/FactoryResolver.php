...
namespace CurieRO\DI\Definition\Resolver;
...
use CurieRO\DI\Invoker\FactoryParameterResolver;
use CurieRO\Invoker\Exception\NotCallableException;
use CurieRO\Invoker\Exception\NotEnoughParametersException;
