...
class GetFixedLocations implements Contract
{
    ...
    {
        return array_filter(['Courier' => $this->courier, 'CountryCode' => $this->countryCode, 'CountyName' => $this->countyName, 'LocalityName' => $this->localityName, 'FixedLocationType' => $this->fixedLocationType, 'ShowInactive' => $this->showInactive, 'RestrictionParcelsCount' => $this->restrictionParcelsCount, 'RestrictionSizeHeight' => $this->restrictionSizeHeight, 'RestrictionSizeWidth' => $this->restrictionSizeWidth, 'RestrictionSizeLength' => $this->restrictionSizeLength, 'ExternalLocationId' => $this->externalLocationId]);
    }
}
