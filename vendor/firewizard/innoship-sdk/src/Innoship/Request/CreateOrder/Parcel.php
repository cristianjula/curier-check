...
class Parcel implements Contract
{
    ...
    {
        return array_filter(['SequenceNo' => $this->sequenceNo, 'Size' => $this->size->data(), 'Weight' => $this->weight, 'Type' => $this->type, 'Reference1' => $this->reference1, 'CustomerBarcode' => $this->customerBarcode], function ($el) {
            return $el !== null && $el !== [];
        });
    }
}
