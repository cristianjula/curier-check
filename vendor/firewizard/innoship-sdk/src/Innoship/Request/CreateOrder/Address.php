...
class Address implements Contract
{
    ...
    {
        return array_filter(['Name' => $this->name, 'ContactPerson' => $this->contactPerson, 'Country' => $this->country, 'CountyName' => $this->countyName, 'LocalityName' => $this->localityName, 'AddressText' => $this->addressText, 'PostalCode' => $this->postalCode, 'Phone' => $this->phone, 'Email' => $this->email, 'FixedLocationId' => $this->fixedLocationId, 'CourierFixedLocationId' => $this->courierFixedLocationId], function ($el) {
            return $el !== null;
        });
    }
}
