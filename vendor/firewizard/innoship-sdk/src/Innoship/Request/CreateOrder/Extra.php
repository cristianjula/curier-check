...
namespace CurieRO\Innoship\Request\CreateOrder;

use CurieRO\Innoship\Traits\Setter;
use CurieRO\Innoship\Request\Contract;
/**
...
class Extra implements Contract
{
    ...
    {
        return array_filter(['BankRepaymentAmount' => $this->bankRepaymentAmount, 'BankRepaymentCurrency' => $this->bankRepaymentCurrency, 'Bank' => $this->bank, 'BankIban' => $this->bankIban, 'CashOnDeliveryAmount' => $this->cashOnDeliveryAmount, 'cashOnDeliveryAmountCurrency' => $this->cashOnDeliveryAmountCurrency, 'DeclaredValueAmount' => $this->declaredValueAmount, 'DeclaredValueAmountCurrency' => $this->declaredValueAmountCurrency, 'OpenPackage' => $this->openPackage, 'SaturdayDelivery' => $this->saturdayDelivery, 'InsuranceAmount' => $this->insuranceAmount, 'Reference1' => $this->reference1, 'Reference2' => $this->reference2, 'Reference3' => $this->reference3, 'Reference4' => $this->reference4, 'ReturnOfDocuments' => $this->returnOfDocuments, 'ReturnOfDocumentsComment' => $this->returnOfDocumentsComment, 'ReturnPackage' => $this->returnPackage], function ($el) {
            return $el !== null;
        });
    }
}
