...
class CreateOrder implements Contract
{
    ...
    protected $parameters = ['GetParcelsBarcodes' => \false, 'IncludeCourierResponse' => \false, 'IncludePriceBreakdown' => \false];
    /** @var array */
    ...
    {
        return array_filter(['ServiceId' => $this->serviceId, 'CourierId' => $this->courierId, 'ShipmentDate' => $this->shipmentDate, 'ShipmentDateEnd' => $this->shipmentDateEnd, 'AddressFrom' => $this->addressFrom->data(), 'AddressTo' => $this->addressTo->data(), 'Payment' => $this->payment, 'Content' => $this->content->data(), 'Extra' => $this->extra->data(), 'ExternalClientLocation' => $this->externalClientLocation, 'ExternalOrderId' => $this->externalOrderId, 'SourceChannel' => $this->sourceChannel, 'Observation' => $this->observation, 'Parameters' => array_filter($this->parameters), 'CustomAttributes' => $this->customAttributes]);
    }
    /**
     ...
     * @return $this
     */
    public function returnParcelsBarcodes(bool $flag = \true): self
    {
     ...
     * @return $this
     */
    public function includeCourierResponse(bool $flag = \true): self
    {
     ...
     * @return $this
     */
    public function includePriceBreakdown(bool $flag = \true): self
    {
